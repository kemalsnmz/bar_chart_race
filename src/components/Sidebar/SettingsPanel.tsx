    ...
    <div className="fl-panel">
      ...
      <Section title="Color">
        ...
        <div style={{ marginTop: 10, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 8 }}>
          <span className="fl-tiny-label" style={{ marginBottom: 0, flexShrink: 0 }}>Themes</span>
          {[
            { label: 'White', bg: '#FFFFFF', titleColor: '#111111', labelColor: '#222222', valueColor: '#111111', tickerTextColor: '#111111', gridColor: '#cccccc', gridLabelColor: '#666666' },
            { label: 'Paper', bg: '#F5EFE0', titleColor: '#1A1208', labelColor: '#2C1F0E', valueColor: '#1A1208', tickerTextColor: '#1A1208', gridColor: '#C8B89A', gridLabelColor: '#7A6040' },
            { label: 'Dark',  bg: '#12141A', titleColor: '#FFFFFF', labelColor: '#FFFFFF', valueColor: '#FFFFFF', tickerTextColor: '#FFFFFF', gridColor: '#2a2a3a', gridLabelColor: '#888899' },
            { label: 'Navy',  bg: '#0A0C10', titleColor: '#FFFFFF', labelColor: '#FFFFFF', valueColor: '#FFFFFF', tickerTextColor: '#FFFFFF', gridColor: '#1A1E28', gridLabelColor: '#4A5568' },
          ].map(t => (
            <button
              key={t.label}
              title={t.label}
              onClick={() => updateSettings({ backgroundColor: t.bg, titleColor: t.titleColor, labelColor: t.labelColor, valueColor: t.valueColor, tickerTextColor: t.tickerTextColor, gridColor: t.gridColor, gridLabelColor: t.gridLabelColor })}
              style={{
                width: 28, height: 28, borderRadius: 6,
                background: t.bg,
                border: (settings.backgroundColor || '#ffffff').toLowerCase() === t.bg.toLowerCase()
                  ? '2px solid var(--accent)' : '2px solid rgba(0,0,0,0.18)',
      ...
      <Section title="Header">
        ...
        {/* ── Appearance ── */}
        <div className="fl-sub-heading" style={{ marginTop: 8, marginBottom: 4 }}>
        ...
        <div className="fl-field" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <input type="number" className="form-input spinner-visible" min={20} max={80} step={1}
        ...
        <div className="cp-field">
          ...
          <ColorPicker value={settings.titleColor || '#000000'}
        ...
        <div className="fl-field" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Entrance</label>
          <div className="fl-tabs" style={{ margin: 0 }}>
            {(['none', 'fade', 'typewriter'] as const).map(anim => (
              <button key={anim}
                className={'fl-color-tab' + ((settings.titleAnimation ?? 'none') === anim ? ' fl-color-tab-active' : '')}
                style={{ justifyContent: 'center', textTransform: 'capitalize' }}
                onClick={() => updateSettings({ titleAnimation: anim })}>
                {anim === 'typewriter' ? 'Type' : anim.charAt(0).toUpperCase() + anim.slice(1)}
              </button>
            ))}
          </div>
        </div>
      ...
      <Section title="Label" defaultOpen={false}>
        ...
        <div className="cp-field">
          <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Color</label>
          <ColorPicker value={settings.valueColor || ''} onChange={v => updateSettings({ valueColor: v })} />
        </div>
      ...
      <Section title="Bars" defaultOpen={false}>
        ...
        <div className="fl-field" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Swap Speed</label>
          <input type="number" className="form-input spinner-visible" min={0.1} max={5} step={0.1}
            value={settings.rankSwapSpeed ?? 1.0}
            onChange={e => updateSettings({ rankSwapSpeed: Number(e.target.value) })}
            style={{ width: 64, textAlign: 'center', padding: '3px 4px' }} />
        </div>
      ...
      {/* ════ Motion Engine ════ */}
      <Section title="Motion Engine" defaultOpen={false}>

        <div className="fl-field" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Spring physics</label>
          <div className="fl-tabs" style={{ margin: 0 }}>
        ...
        {settings.springEnabled && (
          <>
            <div className="fl-field">
              <label className="fl-tiny-label">Preset</label>
              <div className="fl-tabs" style={{ margin: 0, flexWrap: 'wrap' }}>
                {(['cinematic', 'smooth', 'energetic', 'snappy', 'custom'] as const).map(p => (
                  <button key={p}
                    className={'fl-color-tab' + (settings.springPreset === p ? ' fl-color-tab-active' : '')}
                    style={{ flex: '1 1 auto', justifyContent: 'center', textTransform: 'capitalize' }}
            ...
            {settings.springPreset === 'custom' && (
              <>
                <div className="fl-sub-heading" style={{ marginTop: 6, marginBottom: 4 }}>
                  <span>Value Spring</span>
                  <div className="fl-sub-line" />
                </div>

                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Stiffness</label>
                    <span className="fl-val-badge">{settings.springCustomValueStiffness}</span>
                  </div>
                  <input type="range" className="fl-slider" min={20} max={500} step={10}
                    value={settings.springCustomValueStiffness}
                    onChange={e => updateSettings({ springCustomValueStiffness: Number(e.target.value) })} />
                </div>

                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Damping</label>
                    <span className="fl-val-badge">{settings.springCustomValueDamping}</span>
                  </div>
                  <input type="range" className="fl-slider" min={5} max={60} step={1}
                    value={settings.springCustomValueDamping}
                    onChange={e => updateSettings({ springCustomValueDamping: Number(e.target.value) })} />
                </div>

                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Mass</label>
                    <span className="fl-val-badge">{settings.springCustomValueMass.toFixed(1)}</span>
                  </div>
                  <input type="range" className="fl-slider" min={0.3} max={2.0} step={0.1}
                    value={settings.springCustomValueMass}
                    onChange={e => updateSettings({ springCustomValueMass: Number(e.target.value) })} />
                </div>

                <div className="fl-sub-heading" style={{ marginTop: 6, marginBottom: 4 }}>
                  <span>Rank Spring</span>
                  <div className="fl-sub-line" />
                </div>
                ...
                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Stiffness</label>
                    <span className="fl-val-badge">{settings.springCustomRankStiffness}</span>
                  </div>
                  <input type="range" className="fl-slider" min={20} max={500} step={10}
                    value={settings.springCustomRankStiffness}
                    onChange={e => updateSettings({ springCustomRankStiffness: Number(e.target.value) })} />
                </div>

                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Damping</label>
                    <span className="fl-val-badge">{settings.springCustomRankDamping}</span>
                  </div>
                  <input type="range" className="fl-slider" min={5} max={60} step={1}
                    value={settings.springCustomRankDamping}
                    onChange={e => updateSettings({ springCustomRankDamping: Number(e.target.value) })} />
                </div>

                <div className="fl-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    <label className="fl-tiny-label" style={{ marginBottom: 0 }}>Mass</label>
                    <span className="fl-val-badge">{settings.springCustomRankMass.toFixed(1)}</span>
                  </div>
                  <input type="range" className="fl-slider" min={0.3} max={2.0} step={0.1}
                    value={settings.springCustomRankMass}
                    onChange={e => updateSettings({ springCustomRankMass: Number(e.target.value) })} />
                </div>
              </>
            )}
          </>
      ...
      {/* ════ Video Clips ════ */}
      <Section title="Video Clips / Image" defaultOpen={false}>
